        ...
        html.Div(className='content',children=[
            html.Div(className='description', children=[
                ...
                html.Ul([
                    ...
                    html.Li("The color of the bubble indicates the average z-scores of temperature and humidity for the match in question. Where the z-score shows how much higher or lower the temperature, as well as the humidity, deviates from the norm"),
